...
public partial class Harrower : BaseCreature
{
    ...
    public override int HitsMax => _trueForm ? 65000 : 30000;

    [CommandProperty(AccessLevel.GameMaster)]
    public override int ManaMax => 5000;

    public override bool DisallowAllMoves => _trueForm;
    ...
    public static Harrower Spawn(Point3D platLoc, Map platMap)
    {
        ...
        harrower._gateItem = new HarrowerGate(harrower, platLoc, platMap, entry.m_Entrance, Map.Felucca);
    ...
    private void Deserialize(IGenericReader reader, int version)
    {
        ...
        _gateItem = reader.ReadEntity<Item>();
        _tentacles = reader.ReadEntityList<HarrowerTentacles>();
    }
